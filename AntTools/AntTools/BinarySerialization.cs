...
namespace Illumina.AntTools
{
            ...
            using (BinaryWriter writer = new BinaryWriter(ds))
            {
                ...
                foreach (AnnotationResult result in annotation)
                {
                    if (result.Annotation == null)
                        result.Annotation = new Dictionary<string, Dictionary<string, Dictionary<string, string>>>();
    ...
    {
        // previously used an Enum for the group names...these extension methods help maintain backwards compatibility
        internal static readonly string[] GroupNameLookup = new string[]
                {
                    "Allelic",
                    "ClinVar",
                    "Cosmic",
        ...
        public static string ToEnum(this ushort index)
        {
            return GroupNameLookup[index];
        }

        public static ushort ToIndex(this string groupName)
        {
